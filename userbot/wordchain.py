...
@on_event(events.NewMessage(outgoing=True, func=lambda e: e.is_group))
@retry()
    ...
    if "Turn:" in text:
        try:
            ...
            for entity in entities:
                ...
                if entity_type_name(entity) == MessageEntityType.TEXT_MENTION:
            ...
            if first_mention and first_mention.id == client.uid:
                ...
                if not filtered_words:
                    await bot.send_message(client.uid,f" No suitable word found.")
                    return
                    ...
                    try:
                        ...
                        if response.entities:
                         for entity in response.entities:
                          if entity_type_name(entity) == MessageEntityType.ITALIC:
           ...
           await bot.send_message(client.uid,f"ERROR: {e}")
