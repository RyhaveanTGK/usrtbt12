# Contributing to ryhavean-userbot

Thanks for your interest! ryhavean-userbot is a feature-rich Telegram userbot built with Pyrogram (Kurigram), offering automation and utility features for power users.
...
```bash
# Clone the repo
git clone https://github.com/ryhavean/ryhavean-userbot.git
cd ryhavean-userbot
...
ryhavean-userbot supports loading community plugins from an external directory
...
- Join the Telegram group: https://t.me/RyhaveanTeam
